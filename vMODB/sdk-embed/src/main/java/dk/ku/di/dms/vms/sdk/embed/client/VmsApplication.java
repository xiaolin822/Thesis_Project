...
import dk.ku.di.dms.vms.sdk.embed.client.external.ExternalClientFactory;
...
public final class VmsApplication {
    ...
    public static VmsApplication build(VmsApplicationOptions options, HttpHandlerBuilder builder) throws Exception {
        ...
        // load external clients from this microservice's resources/app.properties
        ExternalClientFactory externalClientFactory = new ExternalClientFactory();
        externalClientFactory.loadFromClasspathAndRegister("app.properties");


        VmsEventHandler eventHandler = VmsEventHandler.build(vmsIdentifier, transactionManager, vmsInternalPubSubService, vmsMetadata, options, httpHandler, serdes, externalClientFactory);
        ...
        return new VmsApplication( vmsName, vmsMetadata, catalog, eventHandler, transactionManager, transactionScheduler, vmsInternalPubSubService, externalClientFactory );
    }
