...
public final class VmsComplexTransactionTask implements Callable<VmsTransactionTaskResult> {
    ...
    public VmsComplexTransactionTask(ITransactionManager transactionalHandler, long tid, long lastTid, long batch, VmsTransactionSignature signature, int inputSize, String inputQueue){
    ...
    public VmsTransactionTaskResult call() {
        ...
        try{
            ...
            OutboundEventResult eventOutput = new OutboundEventResult(this.tid, this.batch, this.signature.outputQueue(), output,
                    new java.util.HashSet<>(itxCtx.readSet), // RS
                    new java.util.HashSet<>(itxCtx.writeSet), // WS
