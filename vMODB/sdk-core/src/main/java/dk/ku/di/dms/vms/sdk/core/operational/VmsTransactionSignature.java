...
public final class VmsTransactionSignature {
    ...
    // add new external outbound event
    private final String  externalTopic;

    private final Boolean emit;


    public VmsTransactionSignature(Object vmsInstance, Method method, TransactionTypeEnum transactionType, ExecutionModeEnum executionMode, Optional<Method> partitionByMethod, String[] inputQueues, String outputQueue, String  externalTopic, Boolean emit) {
    ...
    public VmsTransactionSignature(Object vmsInstance, Method method, TransactionTypeEnum transactionType, ExecutionModeEnum executionMode, String[] inputQueues, String outputQueue, String  externalTopic, Boolean emit) {
        this.vmsInstance = vmsInstance;
        this.method = method;
        this.transactionType = transactionType;
        this.executionMode = executionMode;
    ...
    public String externalTopic() { return  externalTopic;}

    public Boolean emit(){ return emit;}
