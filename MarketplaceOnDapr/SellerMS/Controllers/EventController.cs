...
public class EventController : ControllerBase
{
    ...
    private static int _endToEndSuccessCount = 0;
    ...
    public ActionResult GetTelemetryMetrics()
    {
        // Returns a pure JSON payload matching the script parsing regex: '"success_count":X'
        return Ok(new { success_count = _endToEndSuccessCount });
    }
    ...
    public ActionResult ProcessNewInvoice([FromBody] InvoiceIssued invoiceIssued)
    {
        try{
            ...
            Interlocked.Increment(ref _endToEndSuccessCount);
            return Ok();
        } catch(Exception e)
        {
